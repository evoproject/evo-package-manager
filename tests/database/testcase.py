...
class TestCase(unittest.TestCase):
    ...
    def setUp(self):
        ...
        if not pisi.api.list_repos():
            pisi.api.add_repo("pardus-2007", "repos/pardus-2007-bin/io-index.xml")
            pisi.api.add_repo("contrib-2007", "repos/contrib-2007-bin/io-index.xml")
            pisi.api.add_repo("pardus-2007-src", "repos/pardus-2007/io-index.xml")
