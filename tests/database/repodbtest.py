...
class RepoDBTestCase(testcase.TestCase):
    ...
    def testAddRemoveRepo(self):
        ...
        repo = pisi.db.repodb.Repo(pisi.uri.URI("repos/contrib-2007/io-index.xml"))
    ...
    def testAddRemoveCycle(self):
        for r in range(30):
            ...
            repo = pisi.db.repodb.Repo(pisi.uri.URI("http://test-repo/io-index.xml"))
    ...
    def testGetRepo(self):
        ...
        uri = repo.indexuri
        assert uri.get_uri() == "repos/pardus-2007-bin/io-index.xml"
    ...
    def testRepoOrder(self):
        ...
        repoorder.add("test-repo", "http://test-repo/io-index.xml")
