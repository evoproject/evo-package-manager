...
class BuildPo(build):
    ...
    def build_po(self):
        ...
        filelist.extend(["io-cli", "io.xml.in.h", optparse_path])
        filelist.sort()
...
class Install(install):
    ...
    def generateConfigFile(self):
        ...
        confFile = os.path.join(destpath, "io.conf")
        if os.path.isfile(confFile): # Don't overwrite existing io.conf
            return
...
setup(name="evoio",
    ...
    license="GNU GPL2",
    author="Evo Project (Previously Pardus Developers)",
