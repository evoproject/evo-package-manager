...
class Constants:
    ...
    def __init__(self):
        ...
        self.__c.package_suffix = ".io"

        # delta suffix for package names
        self.__c.delta_package_suffix = ".delta.io"
        ...
        self.__c.mirrors_conf = "/usr/share/defaults/io/mirrors.conf"
        self.__c.sandbox_conf = "/usr/share/defaults/io/sandbox.conf"
        self.__c.blacklist = "/etc/io/blacklist"
