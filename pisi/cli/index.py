...
usage = _("""Index io files in a given directory

Usage: index <directory> ...

This command searches for all io files in a directory, collects io
tags from them and accumulates the information in an output XML file,
named by default 'io-index.xml'. In particular, it indexes both
...
class Index(command.Command):
    ...
    def options(self):
        ...
        group.add_option("--skip-sources",
                         action="store_true",
                         default=False,
                         help=_("Do not index io spec files."))
